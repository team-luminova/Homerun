...
import net.chlod.minecraft.homerun.config.selectors.ChunkRetentionSelector
...
class ResetParameters(
     ...
     */
    val retainedChunks: List<ChunkRetentionSelector>,
    /**
     ...
     */
    val outsidePlayerBehavior: OutsidePlayerBehavior?
    ...
    companion object {
        ...
        fun deserialize(args: Map<String, Object>): ResetParameters {
            ...
            val retainedChunks: MutableList<ChunkRetentionSelector> = ArrayList()
                ...
                for (selector in retainedChunksRaw) {
                    for (selectorType in SELECTORS) {
                        try {
                            ...
                            retainedChunks.add(deserialized as ChunkRetentionSelector)
    ...
    enum class OutsidePlayerBehavior {
        ...
        /**
         * Teleport players to the closest valid space inside the reset area.
         */
        CLOSEST
    }
